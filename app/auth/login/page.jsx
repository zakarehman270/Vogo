...
const page = () => {
    ...
    return (
        <CardLayout title="Sign in to VOGO" subtitle={"Welcome back! Please sign in to continue"} bottomTitle={"Don't have account?"} linkText={"Sign up"}  linkRouter={"/auth/register" }  >
